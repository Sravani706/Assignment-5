...
\begin{align*}
\frac{\vec{y^2}}{\vec{a^2}}- \frac{\vec{x^2}}{\Vec{b^2}} = 1
\end{align*}
Thus, based on the values of vertices and equation form
\begin{align}
\vec{a}=\frac{\sqrt{11}}{2}\\
\vec{a^2}=\frac{11}{2}
\end{align}
Also, The giver coordinate of foci are \myvec{0 \\\pm 3}
We know that foci= \myvec{0 \\\pm c}
\begin{align}
Thus\  \vec{C}=3
\end{align}
We know that,
...
3^2= \frac{11}{4}^2+\vec{b^2}\\
\vec{b^2}= \frac{11}{4}^2- 3^2\\
\vec{b^2}= \frac{36 -11}{4}\\
\vec{b^2}=\frac{25}{4}
\end{align}
The equation of hyperbola is-
\begin{align}
\frac{\vec{y^2}}{\vec{a^2}}- \frac{\vec{x^2}}{\vec{b^2}} = 1
\end{align}
substitute the values to get equation for hyperbola-
\begin{align}
\frac{\vec{y^2}}{\frac{11}{4}}+ \frac{\vec{x^2}}{\frac{25}{4}} = 1\\
100\vec{y^2}-44\vec{x^2} = 275
\end{align}
\begin{figure}[ht]
    \centering
